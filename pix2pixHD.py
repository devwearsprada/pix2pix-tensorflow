...
def create_generator(generator_inputs, generator_outputs_channels):
    ...
    # encoder_1: [batch, 1024, 1024, in_channels] => [batch, 128, 128, ngf]
    ...
    # decoder_1: [batch, 128, 128, ngf * 2] => [batch, 1024, 1024, generator_outputs_channels]
...
def create_model(inputs, targets):
    def create_discriminator(discrim_inputs, discrim_targets):
        ...
        # layer_1: [batch, 1024, 1024, in_channels * 2] => [batch, 128, 128, ndf]
